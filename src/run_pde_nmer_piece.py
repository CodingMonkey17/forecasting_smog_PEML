...
# %% [markdown]
# ### Save params to file
best_params_filename_updated = f'best_params_{NN_TYPE}_no2_{LOSS_FUNC}_{years}_updated.txt'

# %%
import json
best_params_file_path = f"{RESULTS_PATH}/best_params/{best_params_filename_updated}"
